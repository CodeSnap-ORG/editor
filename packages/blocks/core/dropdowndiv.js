...
Blockly.DropDownDiv.createDom = function () {
  ...
  Blockly.DropDownDiv.content_ = goog.dom.createDom(
    "div",
    "blocklyDropDownContent",
  );
  Blockly.DropDownDiv.DIV_.appendChild(Blockly.DropDownDiv.content_);
  Blockly.DropDownDiv.arrow_ = goog.dom.createDom(
    "div",
 ...
 */
Blockly.DropDownDiv.showPositionedByBlock = function (
  owner,
  block,
  opt_onHide,
...
Blockly.DropDownDiv.show = function (
  ...
  div.style.direction =
    owner.sourceBlock_ && owner.sourceBlock_.RTL ? "rtl" : "ltr";
...
Blockly.DropDownDiv.getPositionMetrics = function (
  ...
  var div = Blockly.DropDownDiv.DIV_;
  var boundPosition =
    Blockly.DropDownDiv.boundsElement_.getBoundingClientRect();
  ...
  var arrowY = renderedSecondary
    ? divSize.height - Blockly.DropDownDiv.BORDER_SIZE
    : 0;
  arrowY -=
    Blockly.DropDownDiv.ARROW_SIZE / 2 + Blockly.DropDownDiv.BORDER_SIZE;
