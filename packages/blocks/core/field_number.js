 ...
 */
Blockly.FieldNumber.prototype.getNumRestrictor = function (
  opt_min,
  opt_max,
  opt_precision,
) {
 ...
 */
Blockly.FieldNumber.prototype.setConstraints_ = function (
  opt_min,
  opt_max,
  opt_precision,
) {
  this.decimalAllowed_ =
    typeof opt_precision == "undefined" ||
    isNaN(opt_precision) ||
    opt_precision == 0 ||
    Math.floor(opt_precision) != opt_precision;
  this.negativeAllowed_ =
    typeof opt_min == "undefined" || isNaN(opt_min) || opt_min < 0;
...
Blockly.FieldNumber.numPadButtonTouch = function (e) {
  ...
  Blockly.FieldNumber.updateDisplay_(
    newValue,
    selectionStart + spliceValue.length,
  );
