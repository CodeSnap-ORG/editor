...
Blockly.ScratchMsgs.locales["af"] = {
  ...
  PROCEDURE_USED:
    "Om 'n blok definisie te skrap, verwyder eers al die gebruike van die blok",
  NEW_LIST: "Skep ’n Lys",
...
Blockly.ScratchMsgs.locales["ar"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'اسم المتغير "%1" مستخدم مسبقًا في متغير آخر من النوع "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'احذف الاستخدامات الـ%1 للمتغير "%2"؟',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'لا يمكن حذف المتغير "%1" لأنه جزء من تعريف الدالة "%2"',
...
Blockly.ScratchMsgs.locales["am"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'አንድ ተለዋዋጭ "%1" የተሰየመ አስቀድሞ ይኖራል ለሌ ተለዋዋጭ በ"%2" ዓይነት.',
...
Blockly.ScratchMsgs.locales["an"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Ya existe una variable clamada "%1" pa belatra variable de tipo "%2".',
  ...
  PROCEDURE_USED:
    "Antes d'eliminar la definición d'o bloque has d'eliminar totz los suyos usos",
...
Blockly.ScratchMsgs.locales["ast"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Yá hai una variable llamada "%1" para otra variable de tipu "%2".',
  ...
  PROCEDURE_USED:
    "Pa esborrar una definición de bloque, primerto tienes d'esborrar tolos usos del bloque",
...
Blockly.ScratchMsgs.locales["az"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%1" adlı dəyişən digər "%2" növ dəyişən üçün artıq mövcuddur.',
  DELETE_VARIABLE_CONFIRMATION: '%1 silinsin "%2" dəyişənini istifadə edən?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    '"%1" dəyişəni silinə bilmir, çünki "%2" funksiyasındakı tərifin bir hissəsidir',
...
Blockly.ScratchMsgs.locales["bn"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    '"%2" ভ্যারিয়েবল এর ব্যবহৃত %1 অপসারণ করা হবে? ',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'ভ্যারিয়েবল "%1" অপসারণ করতে পারবে না কারণ এটি "%2" ফাংশনের সংজ্ঞার অংশ',
  ...
  PROCEDURE_USED:
    "একটি ব্লকের সংজ্ঞা অপসারণ করতে, প্রথমে ব্লকের সব ব্যবহার অপসারণ কর",
...
Blockly.ScratchMsgs.locales["be"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Зменная з імем "%1" ужо існуе для іншай зменнай тыпу "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'Выдаліць %1 выкарыстанняў "%2" зменнай?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Нельга выдаліць зменную "%1", бо яна частка функцыі "%2"',
...
Blockly.ScratchMsgs.locales["bg"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Променлива "%1" вече съществува за друга променлива от тип "%2".',
  DELETE_VARIABLE_CONFIRMATION:
    'Да изтрия ли %1 блока, в които се използва променливата "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
  ...
  PROCEDURE_USED:
    "За да изтриете дефиниция на блок, първо премахнете използването му.",
...
Blockly.ScratchMsgs.locales["ca"] = {
  ...
  PROCEDURE_USED:
    "Per esborrar la definició d'un bloc, primer cal esborrar-lo de tot arreu on es faci servir",
...
Blockly.ScratchMsgs.locales["cs"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Proměnná téhož jména "%1" již existuje jako jiná proměnná typu "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Smazat %1 výskytů proměnné "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Nelze smazat proměnnou "%1", protože je součástí scénáře funkce "%2"',
  ...
  PROCEDURE_USED:
    "Před smazáním bloku jej nejprve odstraň ze všech míst, kde je použit.",
...
Blockly.ScratchMsgs.locales["cy"] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Methu dileu newidyn "%1" gan ei fod yn rhan o ddiffiniad swyddogaeth "%2"',
...
Blockly.ScratchMsgs.locales["da"] = {
  ...
  PROCEDURE_ALREADY_EXISTS:
    'Der eksisterer allerede en procedure med navnet "%1".',
  PROCEDURE_DEFAULT_NAME: "brikkens navn",
  PROCEDURE_USED:
    "Hvis du vil slette en definition af en blok, skal du først fjerne brugen af den.",
...
Blockly.ScratchMsgs.locales["de"] = {
  ...
  VARIABLE_ALREADY_EXISTS:
    'Eine Variable mit dem Namen "%1" existiert bereits.',
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
  ...
  PROCEDURE_ALREADY_EXISTS:
    'Eine Prozedur mit dem Namen "%1" existiert bereits.',
...
Blockly.ScratchMsgs.locales["et"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Muutuja nimi "%1" on juba kasutusel "%2" tüüpi muutujal.',
...
Blockly.ScratchMsgs.locales["el"] = {
  ...
  PROCEDURE_USED:
    "Για να διαγράψετε τον ορισμό μιας εντολής, πρώτα αφαιρέστε όλες τις χρήσεις της εντολής",
...
Blockly.ScratchMsgs.locales["es"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Ya existe una variable llamada "%1" para otra variable de tipo "%2".',
  ...
  PROCEDURE_USED:
    "Antes de eliminar la definición del bloque debes eliminar todos sus usos",
  NEW_LIST: "Crear una lista",
...
Blockly.ScratchMsgs.locales["es-419"] = {
  ...
  PROCEDURE_DEFAULT_NAME: "nombre del bloque",
  PROCEDURE_USED:
    "Para eliminar una definición de bloque, primero borre todos sus usos",
  NEW_LIST: "Crear una lista",
...
Blockly.ScratchMsgs.locales["eo"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Variablo nomita "%1" jam ekzistas por alia variablo de typo "%2".',
  DELETE_VARIABLE_CONFIRMATION:
    'Ĉu vi volas forigi %1 uzojn de la variablo "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ne eblas forigi la variablon "%1" ĉar ĝi uziĝas en la difino de la funkcio "%2"',
  ...
  PROCEDURE_USED:
    "Antaŭ ol forigi difinon de iu bloko, vi devas unue forigi ĉiun uzon de la bloko",
...
Blockly.ScratchMsgs.locales["eu"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%2" motako beste aldagai batek badu lehendik "%1" izena.',
...
Blockly.ScratchMsgs.locales["fa"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "هم‌ اکنون متغیری به نام «%1» برای متغیر دیگری از نوع «%2» وجود دارد.",
  DELETE_VARIABLE_CONFIRMATION:
    "آیا هر %1 موردی که از متغیر «%2» استفاده شده است، حذف شود؟",
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    "امکان حذف متغیر «%1» نیست. زیرا جزئی از تعریف تابع «%2» است",
  ...
  PROCEDURE_USED:
    "برای حذف قطعه تعریف، ابتدا باید آن را در هر جایی که استفاده شده است، حذف کنید",
...
Blockly.ScratchMsgs.locales["fil"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    'Tanggalin ang %1 (na) paggamit ng "%2" na variable?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
...
Blockly.ScratchMsgs.locales["fr"] = {
  ...
  PROCEDURE_USED:
    "Pour supprimer la définition d'un bloc, supprimez d'abord toutes les utilisations de ce bloc",
...
Blockly.ScratchMsgs.locales["fy"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    '%1 ynstânsjes fan de fariabele "%2" fuortsmite?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
  ...
  PROCEDURE_USED:
    "Om in blokdefinysje te wiskjen, ferwiderje earst alle gebrûk fan it blok",
...
Blockly.ScratchMsgs.locales["ga"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Tá athróg darb ainm "%1" ann cheana, athróg eile de chineál "%2".',
  ...
  PROCEDURE_USED:
    "Chun sainmhíniú ar bhloc a scriosadh, is gá gach úsáid den bhloc a scriosadh ar dtús",
...
Blockly.ScratchMsgs.locales["gd"] = {
  ...
  MOTION_STAGE_SELECTED:
    "Chan eil bloca gluasaid an-seo on a thagh thu àrd-ùrlar",
  OPERATORS_ADD: "%1 + %2",
  OPERATORS_SUBTRACT: "%1 - %2",
  OPERATORS_MULTIPLY: "%1 × %2",
  OPERATORS_DIVIDE: "%1 / %2",
  ...
  DELETE_ALL_BLOCKS:
    "A bheil thu airson na %1 bloca(ichean) uile a sguabadh às?",
  ...
  PROCEDURE_USED:
    "Gus mìneachadh bloca a sguabadh às, thoir air falbh gach cleachdadh a’ bhloca an toiseach",
...
Blockly.ScratchMsgs.locales["gl"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "Xa existe unha variábel chamada «%1» para outra variábel de tipo «%2».",
  ...
  PROCEDURE_USED:
    "Para borrar unha definición de bloque, primeiro retira todos os usos do bloque.",
...
Blockly.ScratchMsgs.locales["ko"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '이름이 "%1"인 변수는 이미 "%2" 형태의 다른 변수로 존재합니다.',
  DELETE_VARIABLE_CONFIRMATION: '"%2" 변수가 사용된 %1곳을 삭제할까요?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    '"%2" 함수의 정의 중 일부분이기 때문에 "%1" 변수를 삭제할 수 없습니다.',
...
Blockly.ScratchMsgs.locales["ha"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    'goge amfanonin %1 na daga abu mai canzawan "%2" ',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
  ...
  PROCEDURE_USED:
    "dan goge ma'anar tubali, da farko cire duk amfanonin tubalin",
...
Blockly.ScratchMsgs.locales["hy"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "«%1» անունով փոփոխականն արդեն առկա է «%2» տիպի մեջ:",
  ...
  PROCEDURE_USED:
    "Մասնիկը ջնջելու համար, նախ պետք է ջնջել նրա բոլոր կիրառումները:",
...
Blockly.ScratchMsgs.locales["he"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'משתנה בשם  "%1" כבר קיים למשתנה אחר "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'האם  למחוק את %1 השימושים של המשתנה "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'לא ניתן למחוק את המשתנה "%1" מפני שזה חלק מהגדרת הפונקציה "%2"',
  ...
  PROCEDURE_USED:
    "כדי למחוק הגדרה של בלוק כלשהו, ראשית יש להסיר את כל השימושים של אותו הבלוק",
...
Blockly.ScratchMsgs.locales["hi"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%1" नामक चर-पद पहलेसे उपलब्ध दूसरे चर-पद के लिए "%2" लिखे',
  DELETE_VARIABLE_CONFIRMATION: '"%2" चर-पद का %1 उपयोग मिटाये?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    '"%1" चर-पद को मिटा नहीं सकते, क्योंकि यह समीकरण "%2" की व्याख्या का भाग है ',
  ...
  PROCEDURE_USED:
    "ब्लॉक परिभाषा को हटाने के लिए, पहले ब्लॉक के सभी उपयोगों को हटा दें",
  NEW_LIST: "सूची बनाये",
...
Blockly.ScratchMsgs.locales["hr"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Varijabla "%1" već postoji kod druge varijable tipa "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Izbriši %1 upotrebu varijable "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ne mogu izbrisati varijablu "%1" jer je dio definicije funkcije "%2"',
...
Blockly.ScratchMsgs.locales["xh"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'ivariyebhl egama "%1" seyikhona endaweni yenye ivariyebhl eludidi "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'cima %1 imisebenzi "%2" variyebhl?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'awukwazi ukucima ivariyebhl "%1" ngoba iyinxalenye yengcaciso yomsebenzi "%2"',
  ...
  PROCEDURE_USED:
    "xa ucima  inkcazo yebhloko, qala ngokususa yonke imisebenzi yebhloko.",
...
Blockly.ScratchMsgs.locales["zu"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    ' Igama lokuguqukayo "%1" selikhona kokunye okuguqukayo kwe "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'Cisha %1 ukusetshenziswa kwe "%2" okuguqukayo',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ngeke ucishe okuguqukayo"%1" ngoba iyingxenye yencazelo yalomsebenzi "%2"',
  ...
  PROCEDURE_USED:
    "Ukuze ususe incazelo yebhulokisi, qala usule konke okusebenzile kwale bhulokisi",
  NEW_LIST: "Yenza uhlu ",
...
Blockly.ScratchMsgs.locales["is"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    'Þú ert að nota "%2" á %1 stöðum. Viltu samt eyða breytunni?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
...
Blockly.ScratchMsgs.locales["it"] = {
  ...
  RENAME_VARIABLE_TITLE:
    'Rinomina tutti i riferimenti alla variabile "%1" come:',
  ...
  DELETE_VARIABLE_CONFIRMATION:
    'Eliminare tutti i %1 riferimenti alla variabile "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
...
Blockly.ScratchMsgs.locales["ka"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'ცვლადი სახელად "%1" უკვე არსებობს სხვა ცვლადების ტიპისათვის "%2" ',
  ...
  PROCEDURE_USED:
    "ბლოკის განსაზღვრის წასაშლელად ჯერ მისი ყველა გამოყენება ამოიღე",
...
Blockly.ScratchMsgs.locales["kk"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%1" атты айнымалы "%2" типіндегі басқа айнымалыға арнап жарияланған.',
  DELETE_VARIABLE_CONFIRMATION:
    "%2 айнымалысның %1 пайдаланылуын өшіру қажет пе?",
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    "%1 айнымалысын өшіру мүмкін емес, себебі ол %2 функциясының мүшесі",
  ...
  PROCEDURE_USED:
    "блок анықтамасын өшіру үшін, алдымен блоктың барлық жердегі қолдануларын өшір",
...
Blockly.ScratchMsgs.locales["qu"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'kay sutiyuq wariable tarikunñam "%1" hukaq warabliman "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Kitay %1 wariablita churay "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'manam kitayta atikunchu "%1" hukaq parti kaptinmi "%2"',
...
Blockly.ScratchMsgs.locales["sw"] = {
  ...
  LOOKS_SWITCHBACKDROPTOANDWAIT:
    "badilisha mandhari ya nyuma kuwa %1 na subiri",
  ...
  DELETE_VARIABLE_CONFIRMATION:
    'Unataka kufuta matumizi %1 ya kibadilika "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Haiwezi kufuta kibadilika "%1" kwa sababu ni sehemu ya kitendaji "%2"',
  ...
  PROCEDURE_USED:
    "Kufuta ufafanuzi wa bloku, anza kwa kutoa matumizi yote ya bloku hiyo",
...
Blockly.ScratchMsgs.locales["ht"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Gen yon varyab ki rele "%1" deja nan kategori "%2"',
  DELETE_VARIABLE_CONFIRMATION:
    'Efase tou le %1 fwa w ap sèvi ak varyab "%2" la ?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Varyab "%1" pa ka efase paske li fè pati fonksyon "%2"',
...
Blockly.ScratchMsgs.locales["ku"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Jixwe berê guheroka "%1"ê bi tîpa "%2"ê heye.',
  DELETE_VARIABLE_CONFIRMATION:
    'Bila bikaranînên %1ê ji guheroka "%2"ê bêne jêbirin?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Jiber ku guheroka "%1"ê beşek ji fonksiyona "%2"ê ye nabe were jêbirin',
  ...
  PROCEDURE_USED:
    "Ji bo jêbirina pênaseya blokekê, pêşî hemû bikaranînên blokê jê bibe",
...
Blockly.ScratchMsgs.locales["ckb"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'گۆڕاوی ناونراو "%1" هەیە بۆ گۆڕاوێکی تر لە جۆری "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'سڕینەوەی %1 بەکارهێنانی "%2" گۆڕاو؟',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'گۆڕاوەی "%1" ناسڕێتەوە چونکە بەشێکە لە پێناسەی فرمانی "%2"',
  ...
  PROCEDURE_USED:
    "بۆ سڕینەوەی پێناسەی بلۆکێک، سەرەتا هەموو بەکارهێنانەکانی ئەو بلۆکە لابە",
...
Blockly.ScratchMsgs.locales["lv"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "Mainīgais \"%1\" jau pastāv citam mainīgajam ar tipu ''%2''.",
  DELETE_VARIABLE_CONFIRMATION: 'Dzēst %1 mainīgā "%2" lietojumus?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Nevar dzēst mainīgo "%1", jo tas ir daļa no funkcijas "%2" definīcijas',
...
Blockly.ScratchMsgs.locales["lt"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Vardas "%1" jau panaudotas kitam "%2" tipo kintamajam.',
  DELETE_VARIABLE_CONFIRMATION: 'Ištrinti %1 atvejus su kintamuoju "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Negalima ištrinti "%1", nes jis yra funkcijos "%2" aprašymo dalis.',
...
Blockly.ScratchMsgs.locales["hu"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "„%1” nevű változó már létezik egy másik „%2” típusú változónál",
  DELETE_VARIABLE_CONFIRMATION: "Törlöd „%2” változót (%1 használat)?",
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    "„%1” változó nem törölhető, mert „%2” függvény leírásának része",
...
Blockly.ScratchMsgs.locales["mi"] = {
  ...
  LOOKS_SWITCHBACKDROPTOANDWAIT:
    "panonitia te ārai tuarongo kia %1, kātahi, tatari",
  ...
  VARIABLE_ALREADY_EXISTS:
    'Kua hangaia kētia tētahi taurangi, ko "%1" te ingoa.',
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
  ...
  PROCEDURE_USED:
    "Hei muku i tētahi tautuhinga paraka, tuatahi, mukua ngā mahinga katoa o te paraka.",
...
Blockly.ScratchMsgs.locales["mn"] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Хувьсагч "%1" нь "%2" функцэд ашиглагдаж байгаа тул устгах боломжгүй',
  DELETE_VARIABLE: 'Хувьсагч "%1"-г устга',
  NEW_PROCEDURE: "Блок үүсгэх",
  PROCEDURE_ALREADY_EXISTS:
    '"%1" нэртэй үйл ажиллагаа аль хэдийн оршиж байна. ',
  PROCEDURE_DEFAULT_NAME: "блокийн нэр",
  PROCEDURE_USED:
    "Блокыг устгах бол эхлээд бүх ашигласан газраасаа арилгана уу",
...
Blockly.ScratchMsgs.locales["nl"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    "Verwijder de %1 toepassingen van de variabele '%2'?",
  CANNOT_DELETE_VARIABLE_PROCEDURE:
  ...
  PROCEDURE_DEFAULT_NAME: "bloknaam",
  PROCEDURE_USED:
    "Om een blokdefinitie te verwijderen, moet je eerst zorgen dat het nergens meer wordt gebruikt.",
...
Blockly.ScratchMsgs.locales["ja-Hira"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'へんすう"%1"は"%2"かたのへんすうとしてすでにそんざいします。',
  DELETE_VARIABLE_CONFIRMATION:
    'へんすう"%2"がつかわれている %1 かしょもさくじょしますか?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'へんすう"%1"はていぎ"%2"でつかわれているためさくじょできません',
  ...
  PROCEDURE_USED:
    "ブロックていぎをさくじょするには、まずそのブロックをつかっているかしょをけしてください。",
  NEW_LIST: "リストをつくる",
...
Blockly.ScratchMsgs.locales["nb"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Det finnes allerede en "%2"-variabel som heter "%1"',
  DELETE_VARIABLE_CONFIRMATION:
    'Slette variabelen "%2" som er brukt %1 ganger?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
  ...
  PROCEDURE_USED:
    "Klossen må slettes fra alle skript før definisjonen kan slettes.",
...
Blockly.ScratchMsgs.locales["oc"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    "Suprimir las utilizacions %1 de la variable « %2 »",
  CANNOT_DELETE_VARIABLE_PROCEDURE:
  ...
  PROCEDURE_USED:
    "Per suprimir la definicion d'un blòc, tirar primièr totas las utilizacions del blòc.",
...
Blockly.ScratchMsgs.locales["or"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%1" ଭେରିଏବଲ୍ ଆଗରୁ ଅଛି, ଅନ୍ୟ ଭେରିଏବଲ୍ ପାଇଁ "%2" ଲେଖ',
  DELETE_VARIABLE_CONFIRMATION: '"%2" ଭେରିଏବଲ୍ ର %1 ବ୍ୟବହାର ଲିଭାଅ ',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    '"%1" ଭେରିଏବଲ୍ କୁ ଲିଭାଇବା ସମ୍ଭବ ନୁହେଁ, କାରଣ ଏହା ଫଙ୍କସନ "%2" ର ଅଂଶ ଅଟେ ',
...
Blockly.ScratchMsgs.locales["uz"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    "\"%2\" o'zgaruvchisi uchun %1 ni o'chirmoqchimisiz?",
  CANNOT_DELETE_VARIABLE_PROCEDURE:
...
Blockly.ScratchMsgs.locales["th"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'มีตัวแปรชื่อ "%1" อยู่แล้วสำหรับตัวแปรอื่นชนิด "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'ลบตัวแปร "%2" ซึ่งใช้อยู่ %1 ที่?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'ไม่สามารถลบตัวแปร "%1" ได้เนื่องจากเป็นส่วนหนึ่งของคำจำกัดความของฟังก์ชัน "%2"',
...
Blockly.ScratchMsgs.locales["km"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'អថេរឈ្មោះ "%1" មានរួចហើយសម្រាប់អថេរប្រភេទ "%2"។',
  DELETE_VARIABLE_CONFIRMATION: 'លុបអថេរ "%2" និងការប្រើប្រាស់ %1 ដងរបស់វា?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'មិនអាចលុបអថេរ "%1" ទេព្រោះវាទាក់ទងនឹងអនុគមន៍ "%2"',
...
Blockly.ScratchMsgs.locales["pl"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Zmienna o nazwie "%1" już istnieje dla innego typu zmiennej "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Czy usunąć %1 używając zmiennej "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Nie można usunąć zmiennej "%1", ponieważ stanowi część definicji funkcji "%2"',
  ...
  PROCEDURE_USED:
    "Aby usunąć blok definicji, najpierw usuń wszystkie jego elementy",
...
Blockly.ScratchMsgs.locales["pt"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "Já existe uma variável com o nome «%1» do tipo «%2».",
  ...
  PROCEDURE_USED:
    "Para remover uma definição de bloco, remova primeiro todas as utilizações desse bloco",
...
Blockly.ScratchMsgs.locales["pt-br"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Uma variável chamada "%1" já existe para outra variável do tipo "%2".',
  ...
  PROCEDURE_DEFAULT_NAME: "nome do bloco",
  PROCEDURE_USED:
    "Para remover a definição de um bloco, elimine primeiro todas as referências a esse bloco.",
  NEW_LIST: "Criar uma Lista",
  NEW_LIST_TITLE: "Nome da nova lista:",
  LIST_MODAL_TITLE: "Nova Lista",
...
Blockly.ScratchMsgs.locales["rap"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'ko ai a te variable iŋoa "%1" mo te rua variable o te huru "%2"',
  DELETE_VARIABLE_CONFIRMATION: '¿haka kore %1 aŋa o te variable "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'ē ko tano mo haka kore te variable "%1" o te ai he tano o te funcion "%2"',
...
Blockly.ScratchMsgs.locales["ro"] = {
  ...
  PROCEDURE_USED:
    "Pentru a șterge definiția unui bloc, mai întâi șterge toate utilizările acestuia.",
...
Blockly.ScratchMsgs.locales["ru"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'переменная с именем "%1" уже существует в другом типе переменных "%2".',
  ...
  PROCEDURE_USED:
    "Прежде чем удалить блок, удалите все случаи его использования.",
...
Blockly.ScratchMsgs.locales["nso"] = {
  ...
  PROCEDURE_USED:
    "Gore o tloše hlalošo ya poloko, thoma ka go tloša di tšhomišo ka moka tša poloko",
...
Blockly.ScratchMsgs.locales["tn"] = {
  ...
  MOTION_STAGE_SELECTED:
    "serala se se tlhophilweng: ga go diboloko tsa motsamao",
  OPERATORS_ADD: "%1 + %2",
  OPERATORS_SUBTRACT: "%1 - %2",
  OPERATORS_MULTIPLY: "%1 * %2",
  OPERATORS_DIVIDE: "%1 / %2",
  ...
  VARIABLE_ALREADY_EXISTS:
    'Pharologano e e bidiwang "%1" e setse e tlhageletse',
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
  ...
  PROCEDURE_USED:
    "Go phimolla tlhaloso ya boloko, sa ntlha tlosa tiriso ya diboloko tsotlhe",
...
Blockly.ScratchMsgs.locales["sk"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Premenná s menom "%1" už existuje pre inú prememnú typu "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Naozaj mám zrušiť %1 výskytov premennej "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Nemôžem zrušiť premennú "%1", pretože je súčasťou definície funkcie "%2".',
  ...
  PROCEDURE_USED:
    "Ak chceš zmazať defíníciu bloku, musíš najprv zmazať všetky jeho použitia",
...
Blockly.ScratchMsgs.locales["sl"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Spremenljivka z imenom "%1" že obstaja in je tipa "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Izbrisati %1 uporab spremenljivke "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ne morem izbrisati spremenljivke "%1", ker je del definicije funkcije "%2"',
  DELETE_VARIABLE: 'Izbriši spremenljivko "%1"',
  NEW_PROCEDURE: "Ustvari blok",
  PROCEDURE_ALREADY_EXISTS: 'Postopek z imenom "%1" že obstaja',
  PROCEDURE_DEFAULT_NAME: "ime bloka",
  PROCEDURE_USED:
    "Preden izbrišeš definicijo delčka (bloka), se najprej prepričaj, da ni nikjer uporabljen.",
...
Blockly.ScratchMsgs.locales["sr"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Име променљиве "%1" већ постоји код друге променљиве типа "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Обрисати %1 употреба променљиве "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Не могу да обришем променљиву "%1" зато што је она део дефиниције функције "%2"',
  ...
  PROCEDURE_USED:
    "Да би обрисао дефиницију блока, прво уклони све употребе блока",
...
Blockly.ScratchMsgs.locales["fi"] = {
  ...
  DELETE_VARIABLE_CONFIRMATION:
    'Poistetaanko "%2"-muuttujan %1 käyttökohdetta?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ei voitu poistaa "%1"-muuttujaa, koska se on osa "%2"-funktion määrittelyä',
  ...
  PROCEDURE_USED:
    "Poistaaksesi lohkon määrityksen, poista ensin kaikki missä tätä lohkoa käytetään",
  NEW_LIST: "Tee lista",
...
Blockly.ScratchMsgs.locales["sv"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'En variabel "%1" finns redan för en annan variabel av typ "%2".',
...
Blockly.ScratchMsgs.locales["vi"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Một biến số tên là "%1" đã có ở trong một biến số khác tên "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'Xóa %1 cách dùng của biến số "%2"',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Không thể xóa biến số "%1" tại vì nó là một phần của chức vụ lập trình "%2"',
...
Blockly.ScratchMsgs.locales["tr"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%2" türünde başka bir değişken için "%1" adlı bir değişken zaten var.',
  DELETE_VARIABLE_CONFIRMATION: '"%2" değişkeninin %1 kullanımı silinsin mi?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    '"%1" değişkenini "%2" fonksiyonunun bir parçası olduğundan dolayı silinemez',
  ...
  PROCEDURE_USED:
    "Bir bloğun tanımını silmek için önce bloğun tüm kullanımlarını kaldırın.",
...
Blockly.ScratchMsgs.locales["uk"] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Ім\'я змінної "%1" вже використано для змінної з типом "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Вилучити %1 використання змінної "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Не можна вилучити змінну "%1" оскільки вона визначена у функції "%2"',
  ...
  PROCEDURE_USED:
    "Щоб видалити цей блок, спочатку видаліть усі його використання",
