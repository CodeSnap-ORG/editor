...
test("canFetch", async (t) => {
    ...
    vm.securityManager.canFetch = () =>
        t.fail("security manager should be ignored for these protocols");
...
test("canOpenWindow", async (t) => {
    ...
    vm.securityManager.canOpenWindow = () =>
        t.fail("should not call security manager for javascript:");
...
test("canRedirect", async (t) => {
    ...
    // javascript: should never be allowed, shouldn't call security manager
    vm.securityManager.canRedirect = () =>
        t.fail("should not call security manager for javascript:");
