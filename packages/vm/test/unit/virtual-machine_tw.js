...
test("non-primitive values in lists and variables converted to strings", (t) => {
    ...
    target.variables.var1 = new Variable(
        "var",
        "test var",
    ...
    target.variables.var2 = new Variable(
        "var2",
        "test var",
        Variable.SCALAR_TYPE,
        false,
    ...
    target.variables.var3 = new Variable(
        "var3",
        "test var",
        Variable.SCALAR_TYPE,
        false,
    ...
    target.variables.var4 = new Variable(
        "var4",
        "test var",
        Variable.SCALAR_TYPE,
        false,
    ...
    target.variables.var5 = new Variable(
        "var5",
        "test var",
        Variable.SCALAR_TYPE,
        false,
    ...
    target.variables.var6 = new Variable(
        "var6",
        "test var",
        Variable.SCALAR_TYPE,
        false,
    ...
    target.variables.list = new Variable(
        "list",
        "test list",
        Variable.LIST_TYPE,
        false,
    ...
    t.deepEqual(json.targets[0].lists.list[1], [
        "abc",
        false,
        1,
        "null",
