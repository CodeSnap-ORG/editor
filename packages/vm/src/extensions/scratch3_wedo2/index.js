...
class WeDo2 {
    ...
    _registerSensorOrMotor(connectID, type) {
        ...
        if (type === WeDo2Device.MOTOR) {
            ...
            const typeString =
                type === WeDo2Device.DISTANCE ? "DISTANCE" : "TILT";
            const cmd = this.generateInputCommand(
                connectID,
                type,
...
class Scratch3WeDo2Blocks {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description:
                            "check for when distance is < or > than reference",
                    }),
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: "distance",
                        description:
                            "the value returned by the distance sensor",
                    }),
                    ...
                    items: [
                        {
                            text: formatMessage({
                                ...
                                default: "motor",
                                description:
                                    "label for motor element in motor menu for LEGO WeDo 2 extension",
                            }),
                        ...
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "motor A",
                                description:
                                    "label for motor A element in motor menu for LEGO WeDo 2 extension",
                            }),
                        ...
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "motor B",
                                description:
                                    "label for motor B element in motor menu for LEGO WeDo 2 extension",
                            }),
                        ...
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "all motors",
                                description:
                                    "label for all motors element in motor menu for LEGO WeDo 2 extension",
                            }),
                    ...
                    items: [
                        {
                            text: formatMessage({
                                ...
                                default: "up",
                                description:
                                    "label for up element in tilt direction menu for LEGO WeDo 2 extension",
                            }),
                        ...
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "down",
                                description:
                                    "label for down element in tilt direction menu for LEGO WeDo 2 extension",
                            }),
                        ...
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "left",
                                description:
                                    "label for left element in tilt direction menu for LEGO WeDo 2 extension",
                            }),
                        ...
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "right",
                                description:
                                    "label for right element in tilt direction menu for LEGO WeDo 2 extension",
                            }),
                    ...
                    items: [
                        ...
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "any",
                                description:
                                    "label for any element in tilt direction menu for LEGO WeDo 2 extension",
                            }),
    ...
    whenDistance(args) {
        switch (args.OP) {
            case "<":
                return (
                    this._peripheral.distance < Cast.toNumber(args.REFERENCE)
                );
            case ">":
                return (
                    this._peripheral.distance > Cast.toNumber(args.REFERENCE)
    ...
    _isTilted(direction) {
        switch (direction) {
            case WeDo2TiltDirection.ANY:
                return (
                    this._getTiltAngle(WeDo2TiltDirection.UP) >=
                        Scratch3WeDo2Blocks.TILT_THRESHOLD ||
                    this._getTiltAngle(WeDo2TiltDirection.DOWN) >=
                        Scratch3WeDo2Blocks.TILT_THRESHOLD ||
                    this._getTiltAngle(WeDo2TiltDirection.LEFT) >=
                        Scratch3WeDo2Blocks.TILT_THRESHOLD ||
                    this._getTiltAngle(WeDo2TiltDirection.RIGHT) >=
                        Scratch3WeDo2Blocks.TILT_THRESHOLD
                );
            default:
                return (
    ...
    _getTiltAngle(direction) {
        switch (direction) {
            case WeDo2TiltDirection.UP:
                return this._peripheral.tiltY > 45
            ...
            case WeDo2TiltDirection.LEFT:
                return this._peripheral.tiltX > 45
