            ...
            blocks: [
                {
                    ...
                    text: formatMessage({
                        ...
                        description:
                            "Block that returns the last key that was pressed",
                    }),
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description:
                            "Block that returns whether a specific mouse button is down",
                    }),
                    ...
                    items: [
                        {
                            text: formatMessage({
                                ...
                                default: "(0) primary",
                                description:
                                    "Dropdown item to select primary (usually left) mouse button",
                            }),
                            value: "0",
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "(1) middle",
                                description:
                                    "Dropdown item to select middle mouse button",
                            }),
                            value: "1",
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "(2) secondary",
                                description:
                                    "Dropdown item to select secondary (usually right) mouse button",
                            }),
                            value: "2",
                        },
                    ],
