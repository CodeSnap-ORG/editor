...
if (process.env.NODE_ENV === "production") {
    throw Error(
        "This project uses an internal test extension and is only intended for development purposes. It may have security flaws and does not have blocks you will need to use, and thus does not load in production environments.",
    );
}
