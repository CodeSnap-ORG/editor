...
export default async function ({ addon, console }) {
    ...
    (function (Blockly) {
        ...
        var originalDropdownObject =
            BlocklyInstance.FieldDropdown.prototype.positionArrow;
        ...
        function applyChanges(
            ...
            BlockSvg.MIN_BLOCK_Y_SINGLE_FIELD_OUTPUT =
            ...
            BlocklyInstance.FieldDropdown.prototype.positionArrow = function (
                x,
            ) {
            ...
            BlockSvg.STATEMENT_INPUT_INNER_SPACE =
                2.8 * GRID_UNIT - 0.9 * GRID_UNIT * cornerSize;
        }
