export default async function ({ addon, msg, console }) {
    ...
    const _CategoryMenuPopulate =
        Blockly.Toolbox.CategoryMenu.prototype.populate;
    Blockly.Toolbox.CategoryMenu.prototype.populate = function (domTree) {
        ...
        for (const child of extensionsNodes) {
            ...
            if (child) {
                this.categories_.push(
                    new Blockly.Toolbox.Category(this, row, child),
                );
            }
        }
        if (!addon.self.disabled) {
            this.height_ =
                this.table.offsetHeight + this.secondTable.offsetHeight;
        }
    };
    ...
    function updateClass() {
        ...
        if (addon.self.disabled)
            document.body.classList.remove("sa-columns-enabled");
    ...
    while (true) {
        ...
        const addExtensionLabel = Object.assign(
