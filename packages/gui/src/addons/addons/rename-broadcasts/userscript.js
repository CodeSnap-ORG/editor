export default async function ({ addon, msg, console }) {
    ...
    Blockly.FieldVariable.dropdownCreate = function () {
        ...
        if (
            ...
            this.sourceBlock_.workspace
                .getVariableTypes()
                .includes("broadcast_msg")
        ) {
            options.push([
                msg("RENAME_BROADCAST"),
    ...
    const resetVMCaches = () => {
        const blockContainers = new Set(
            vm.runtime.targets.map((i) => i.blocks),
        );
    ...
    const mergeBroadcast = (workspace, oldId, oldName, newName) => {
        const newVmVariable = vm.runtime
            .getTargetForStage()
            .lookupBroadcastByInputValue(newName);
    ...
    const promptRenameBroadcast = (workspace, variable) => {
        ...
        Blockly.prompt(
            ...
            function (newName) {
                ...
                const variableAlreadyExists = !!workspace.getVariable(
                    newName,
