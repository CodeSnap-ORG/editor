...
export default class ShowBroadcast {
            ...
            for (const blockId of Object.keys(target.blocks._blocks)) {
                ...
                if (block.inputs.BROADCAST_INPUT) {
                    ...
                    if (
                        ...
                        target.blocks.getBlock(input.shadow).fields
                            .BROADCAST_OPTION.id === broadcastId
                    ) {
        ...
        for (const target of targets) {
            ...
            if (target.isStage) {
                elem = document.querySelector(
                    'div[class*="stage-selector_header"]',
                );
    ...
    getAssociatedBroadcastId(blockId) {
        ...
        if (block.opcode === "event_whenbroadcastreceived") {
            ...
            const input = block.inputs.BROADCAST_INPUT;
            // Allow shadow blocks
            return editingTarget.blocks.getBlock(input.shadow).fields
                .BROADCAST_OPTION.id;
        }
    }
}
