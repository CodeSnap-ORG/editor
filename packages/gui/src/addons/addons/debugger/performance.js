...
export default async function createPerformanceTab({
    ...
    const getMaxFps = () =>
        vm.runtime.frameLoop.framerate === 0
            ? 60
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    callbacks: {
                        label: (context) =>
                            msg("performance-framerate-graph-tooltip", {
    ...
    const performanceClonesChart = new Chart(
        clonesElements.canvas.getContext("2d"),
        {
            type: "line",
            data: {
                labels,
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        callbacks: {
                            label: (context) =>
                                msg("performance-clonecount-graph-tooltip", {
    ...
    debug.addAfterStepCallback(() => {
        ...
        while (renderTimes.length > 0 && renderTimes[0] <= time - 1000)
            renderTimes.shift();
