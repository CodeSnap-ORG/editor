export default async function ({ addon, console, msg }) {
    ...
    function updateLockDisplay() {
        ...
        lockIcon.src = addon.self.getResource(
            `/${flyoutLock ? "" : "un"}lock.svg`,
    ...
    function onmouseenter(e, speed = {}) {
        ...
        if (
            ...
            document
                ...
                .className.includes("blocklyToolboxDelete")
        ) {
    ...
    function doOneTimeSetup() {
        ...
        if (
            ...
            getToggleSetting() === "category" &&
            !addon.settings.get("lockLoad")
        ) {
        ...
        const oldSelectCategoryById =
            Blockly.Toolbox.prototype.selectCategoryById;
        ...
        const oldStepScrollAnimation =
            Blockly.Flyout.prototype.stepScrollAnimation;
    ...
    while (true) {
        ...
        const addExtensionButton = document.querySelector(
        ...
        placeHolderDiv.onmouseenter = (e) => {
            if (!addon.self.disabled && getToggleSetting() === "hover")
                onmouseenter(e);
        };
