...
export default async ({ addon, console, msg }) => {
    ...
    while (true) {
        ...
        const getOptions = () => {
            ...
            const recordOptionSecondsInput = Object.assign(
                document.createElement("input"),
                {
                    ...
                    className: addon.tab.scratchClass(
                        "prompt_variable-name-text-input",
                    ),
                },
            );
            const recordOptionSecondsLabel = Object.assign(
            ...
            const recordOptionDelayInput = Object.assign(
                document.createElement("input"),
                {
                    type: "number",
                    min: 0,
            ...
            const recordOptionDelayLabel = Object.assign(
                document.createElement("label"),
                {
            ...
            // Audio
            const recordOptionAudio = Object.assign(
                document.createElement("p"),
                {
                    className: "mediaRecorderPopupOption",
                },
            );
            const recordOptionAudioInput = Object.assign(
                document.createElement("input"),
                {
                    type: "checkbox",
                    defaultChecked: true,
            ...
            const recordOptionAudioLabel = Object.assign(
                document.createElement("label"),
                {
            ...
            const recordOptionMicInput = Object.assign(
                document.createElement("input"),
                {
                    type: "checkbox",
            ...
            const recordOptionMicLabel = Object.assign(
                document.createElement("label"),
                {
            ...
            // Green flag
            const recordOptionFlag = Object.assign(
                document.createElement("p"),
                {
                    className: "mediaRecorderPopupOption",
                },
            );
            const recordOptionFlagInput = Object.assign(
                document.createElement("input"),
                {
                    type: "checkbox",
                    defaultChecked: true,
            ...
            const recordOptionFlagLabel = Object.assign(
                document.createElement("label"),
                {
            ...
            // Stop sign
            const recordOptionStop = Object.assign(
                document.createElement("p"),
                {
                    className: "mediaRecorderPopupOption",
                },
            );
            const recordOptionStopInput = Object.assign(
                document.createElement("input"),
                {
                    type: "checkbox",
                    defaultChecked: true,
            ...
            const recordOptionStopLabel = Object.assign(
                document.createElement("label"),
                {
            ...
            recordOptionFlagInput.addEventListener("change", () => {
                const disabled = (recordOptionStopInput.disabled =
                    !recordOptionFlagInput.checked);
                if (disabled) {
                    recordOptionStopLabel.title = msg(
                        "record-until-stop-disabled",
                        {
            ...
            startButton.addEventListener(
                ...
                () =>
                    handleOptionClose({
                        ...
                        useStopSign:
                            !recordOptionStopInput.disabled &&
                            recordOptionStopInput.checked,
                    }),
                { once: true },
            );
        ...
        const disposeRecorder = () => {
            ...
            timeout = 0;
            if (stopSignFunc) {
                addon.tab.traps.vm.runtime.off(
                    "PROJECT_STOP_ALL",
                    stopSignFunc,
                );
                stopSignFunc = null;
        ...
        const stopRecording = (force) => {
            ...
            if (force) {
                ...
                recorder.onstop = () => {
                    ...
                    downloadBlob(
                        `${addon.tab.redux.state?.preview?.projectInfo?.title || "video"}.${fileExtension}`,
                        blob,
                    );
                    disposeRecorder();
                };
        ...
        const startRecording = async (opts) => {
            ...
            if (opts.audioEnabled) {
                ...
                vm.runtime.audioEngine.inputNode.connect(
                    mediaStreamDestination,
                );
                const audioSource = ctx.createMediaStreamSource(
