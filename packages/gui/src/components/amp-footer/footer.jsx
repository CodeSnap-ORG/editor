...
const eraseData = async () => {
    if (
        confirm(
            "Please be aware that this will reset all your local data, including the Restore Points and backpack. Only do this if you're experiencing many bugs or errors. Again, this is a last-resort, and all data will be ERASED FROM YOUR BROWSER. Are you sure you want to continue?",
        )
    ) {
