...
const messages = defineMessages({
    authorAttribution: {
        ...
        description:
            "Displayed in StudioView under project title to credit creator",
...
class StudioViewComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        this.studioView.messages.AUTHOR_ATTRIBUTION =
            this.props.intl.formatMessage(messages.authorAttribution, {
                // studioview uses $-based variables
                author: "$author",
            });
        this.studioView.messages.PROJECT_HOVER_TEXT =
            this.props.intl.formatMessage(messages.hoverText, {
                // studioview uses $-based variables
                author: "$author",
                title: "$title",
            });
