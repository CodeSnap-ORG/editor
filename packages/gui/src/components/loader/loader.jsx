...
const funFacts = [
    ...
    "'How to make a computer in AmpMod' Oh wait, this isn't Google, is it?",
    ...
    "Fun fact: AmpMod used to be hosted on GitHub, but is now hosted exclusively on Codeberg.",
    "Fun fact: AmpMod is 100% free and open source software.",
    "Preparing emojis...",
    "Herding cats...",
    "Growing apples...",
    "Removing dangos...",
    ...
    "abc.xyz is the website of Google's subsidiary.",
];
