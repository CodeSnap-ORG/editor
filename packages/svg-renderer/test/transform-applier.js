...
test("transformPath", (t) => {
    ...
    const doubled =
        "M 5 5 L 45 65 L 55 55 L 65 55 L 65 65 C 65 65 85 65 75 95 C 65 125 75 105 75 125 " +
...
test("composedTransformPath", (t) => {
    ...
    const transformedPath =
        "M -29.5 -29 L 0.5 16 L 8 8.5 L 15.5 8.5 L 15.5 16 C 15.5 16 30.5 16 23 38.5 " +
...
test("parentTransformPath", (t) => {
    ...
    const doubled =
        "M -40 -40 L 0 20 L 10 10 L 20 10 L 20 20 C 20 20 40 20 30 50 C 20 80 30 60 30 80 " +
...
test("nestedTransformPath", (t) => {
    ...
    const quartered =
        "M -45 -45 L 0 22.5 L 11.25 11.25 L 22.5 11.25 L 22.5 22.5 C 22.5 22.5 45 22.5 33.75 56.25 " +
...
test("variousTransformsPath", (t) => {
    ...
    const transformedPath =
        "M 115.3172 96.7866 L 134.6908 171.2195 L 151.9584 175.6212 L 164.2563 185.7055 " +
...
test("variousTransformsRelativePath", (t) => {
    ...
    const transformed =
        "M 44.0917 25.6869 L 55.7402 43.813 L 64.0581 39.5868 L 71.1292 42.0053 L 79.447 37.7791 " +
...
test("scaleTransformEllipticalPath", (t) => {
    ...
    const scaled =
        "M 5 150 L 30 137.5 A 12.5 12.5 -50.7685 0 1 55 125 L 80 112.5 A 12.5 25 -45 0 1 105 100 " +
...
test("invertTransformEllipticalPath", (t) => {
    ...
    const inverted =
        "M 300 10 L 275 60 A 25 25 -50.7685 0 0 250 110 L 225 160 A 25 50 -45 0 0 200 210 " +
...
test("rotateTransformEllipticalPath", (t) => {
    ...
    const rotated =
        "M 190.597 61.4231 L 201.8042 116.1898 A 25 25 -50.7685 0 1 213.0114 170.9566 " +
...
test("skewXTransformEllipticalPath", (t) => {
    ...
    const skewed =
        "M -99.1911 300 L -40.0918 275 A 20.861 29.9602 50.1571 0 1 19.0074 250 L 78.1067 225 " +
...
test("skewYTransformEllipticalPath", (t) => {
    ...
    const skewed =
        "M 10 296.3603 L 60 253.1618 A 20.861 29.9602 39.8429 0 1 110 209.9633 L 160 166.7648 " +
...
test("variousTransformsEllipticalPath", (t) => {
    ...
    const transformed =
        "M 24.9709 107.5355 L 51.9997 63.7469 A 22.8929 27.3011 -47.5192 0 1 79.0286 19.9583 " +
